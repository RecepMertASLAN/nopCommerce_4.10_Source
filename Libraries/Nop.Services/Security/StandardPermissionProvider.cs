...
namespace Nop.Services.Security
{
	...
	public partial class StandardPermissionProvider : IPermissionProvider
	{
		...
		//public static readonly PermissionRecord CUSTOMManageMyNewEntities = new PermissionRecord { Name = "Admin area. Manage MyNewEntities", SystemName = "ManageMyNewEntities", Category = "Catalog" };
		...
		// RMA BURAYA EKLEDI // Burasi Eklendi
		public static readonly PermissionRecord CUSTOMManageMyNewEntities = new PermissionRecord { Name = "Admin area. Manage MyNewEntities", SystemName = "ManageMyNewEntities", Category = "Catalog" };	  
