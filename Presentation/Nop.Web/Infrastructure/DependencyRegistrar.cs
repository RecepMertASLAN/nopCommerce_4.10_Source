...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
			...
			builder.RegisterType<MyNewEntityModelFactory>().As<IMyNewEntityModelFactory>().InstancePerLifetimeScope();// Ekleme Yapildi
			builder.RegisterType<MyNewEntityService>().As<IMyNewEntityService>().InstancePerLifetimeScope(); // Ekleme Yapildi
